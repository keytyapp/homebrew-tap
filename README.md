...
The workflow updates [Casks/keyty.rb](/Users/esphynox/Projects/homebrew-tap/Casks/keyty.rb), runs `brew audit --cask --online keyty`, pushes a branch named `release/keyty-<version>`, and opens a pull request.
